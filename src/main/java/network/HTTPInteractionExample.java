...
public class HTTPInteractionExample {
    ...
    public static HttpResponse<String> sendData(HttpClient client, URI service, String jsonData) throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder().uri(service)
                // 1
    ...
    public static HttpResponse<String> sendDataWithRetries(HttpClient client, URI service, String jsonData) throws Exception {
        int retry = 0;
